...
class Agent1(Agent):
    ...
    def init_problem(self) :
        self.problem = Problem1(deepcopy(self.state),self.goal)
...
class Agent_2(Agent):
    ...
    def __init__(self,initial_percept,algo):
        self.seq=[]
        self.update_state(initial_percept)
        self.goal = lambda state : len(state["dirty_room"]) ==0
        self.init_problem()
        self.algo = algo
        self.search()
    ...
    def update_state(self,percept): #= sensor
        self.state={'grid':percept.get_grid(),'pos':percept.agent,'dirty_room':get_dirty_room(percept.get_grid())}


    def init_problem(self) :
        self.problem = Problem_2(deepcopy(self.state),self.goal)
